...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "InternationalConsumptionChain.lnk";
}
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    else
    {
        ...
        optionFile << "Name=InternationalConsumptionChain\n";
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("InternationalConsumptionChain-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  InternationalConsumptionChain-Qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    setWindowTitle(tr("InternationalConsumptionChain-Qt"));
