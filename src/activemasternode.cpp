...
// Copyright (c) 2017 Empinel / The InternationalConsumptionChain Developers
...
//
// Bootup the masternode, look for a 10000 ICC input and register on the network
//
void CActiveMasternode::ManageStatus()
{
    ...
    if(status == MASTERNODE_NOT_PROCESSED) {
        ...
        if(GetMasterNodeVin(vin, pubKeyCollateralAddress, keyCollateralAddress)) {
            ...
            /* donations are not supported in InternationalConsumptionChain.conf */
