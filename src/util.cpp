...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\InternationalConsumptionChain
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\InternationalConsumptionChain
    // Mac: ~/Library/Application Support/InternationalConsumptionChain
    // Unix: ~/.InternationalConsumptionChain
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "InternationalConsumptionChain";
#else
    fs::path pathRet;
    ...
    return pathRet / "InternationalConsumptionChain";
#else
    // Unix
    return pathRet / ".InternationalConsumptionChain";
#endif
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "InternationalConsumptionChain.conf"));
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()){
        // Create empty InternationalConsumptionChain.conf if it does not exist
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "InternationalConsumptionChaind.pid"));
